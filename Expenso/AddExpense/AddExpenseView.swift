...
struct AddExpenseView: View {
    ...
    let tagOptions = [
        ...
        DropdownOption(key: TRANS_TAG_ELECTRONICS, val: "Electronics"),
        ...
        DropdownOption(key: TRANS_TAG_INCOME, val: "Income"),
                    ...
                    ScrollView(showsIndicators: false) {
                        ...
                        VStack(spacing: 12) {
                            ...
                            TextField("Amount", text: $viewModel.amount)
                                ...
                                .frame(height: 50).padding(.leading, 16)
                                .background(Color.secondary_color)
                                .cornerRadius(12).keyboardType(.decimalPad)
                            ...
                            .accentColor(Color.text_primary_color)
                            .background(Color.secondary_color).cornerRadius(12)
